...
const weather_img = document.querySelector('.wather-img');
...
async function checkWeather(city) {
    const api_key = "cece5c068af685f7c308d3da0207e51c";
    ...
    wind_speed.innerHTML = `${weather_data.wind.speed}km/H-WindSpeed`;
